...
const AllFood = () => {
  ...
  useEffect(() => {
    ...
    const fetchFoods = async () => {
      let url = "https://spicybites-server-site.vercel.app/addfood";
      if (searchTerm) {
               ...
               <div className="md:flex">
                 <div className="md:w-2/3 p-4">
                   ...
                   <p className="mt-4 text-gray-700 text-sm md:text-base">
                    We Provide our best food , we have different type of menu,for that the customer can chose any food ther wish
                   </p>
